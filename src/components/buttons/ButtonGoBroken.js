        ...
        <View>
            <TouchableOpacity
                style={[
                    ...
                    {
                        backgroundColor: disabledButtonSwitch || activityIndicatorSwitch ? "#E7E6E6" : "#444647",
                    }
                ]}
                onPress={goBrokenAlert}
            ...
            >
                {activityIndicatorSwitch ?
                    ...
                    <Text style={styles.buttonText}>
                        {activityIndicatorSwitch ? "" : disabledButtonSwitch ? "Блестяще" : "В ПОЛОМКУ"}
                    </Text>
                }
            </TouchableOpacity>
        </View>
